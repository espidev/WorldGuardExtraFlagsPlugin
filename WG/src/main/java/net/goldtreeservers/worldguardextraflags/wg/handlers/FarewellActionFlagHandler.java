...
public class FarewellActionFlagHandler extends HandlerWrapper {
    ...
    public static class Factory extends HandlerWrapper.Factory<FarewellActionFlagHandler>
    {
        ...
        @Override
        public FarewellActionFlagHandler create(Session session)
        {
    ...
    protected FarewellActionFlagHandler(Plugin plugin, Session session)
    {
    ...
    {
        lastActionStack = sendAndCollect(WorldGuardPlugin.inst().wrapPlayer(player), player, toSet, Flags.FAREWELL_ACTION, lastActionStack, MessagingUtil::sendStringToAction);
        return true;
    }
